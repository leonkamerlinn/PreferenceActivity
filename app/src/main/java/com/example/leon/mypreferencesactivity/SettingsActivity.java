...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getFragmentManager()
                .beginTransaction()
                .add(android.R.id.content, new MainPreferencesFragment())
                .commit();
    ...
    public static class MainPreferencesFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
        @Override
        public void onCreate(@Nullable Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_main);

            findPreference(getString(R.string.key_gallery_name))
                    .setOnPreferenceChangeListener(this);

            findPreference(getString(R.string.key_upload_over_wifi))
                    .setOnPreferenceChangeListener(this);

            findPreference(getString(R.string.key_upload_quality))
                    .setOnPreferenceChangeListener(this);
